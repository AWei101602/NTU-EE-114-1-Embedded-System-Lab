...
uint8_t RemoteIP[] = {192,168,50,242};
...
int main(void)
{
  ...
  int16_t pDataXYZ[3];   // 加速度計數據 X, Y, Z
  int i;
  ...
  BSP_ACCELERO_Init();
  //***added
  uint8_t streaming = 1;  // 1=傳送sensor資料, 0=暫停
