...
#define L_ECHO_EXTI_IRQn EXTI0_IRQn
#define R_TRIG_Pin GPIO_PIN_1
#define R_TRIG_GPIO_Port GPIOB
#define R_ECHO_Pin GPIO_PIN_2
#define R_ECHO_GPIO_Port GPIOB
#define R_ECHO_EXTI_IRQn EXTI2_IRQn
...
#define C_ECHO_GPIO_Port GPIOB
#define C_ECHO_EXTI_IRQn EXTI4_IRQn
